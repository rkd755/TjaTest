...
class SingleMapTableViewController: UITableViewController, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.title = sLoc
        sMealDay.textLabel?.text = "설치수"
        sMealDay.detailTextLabel?.text = sItem["setCnt"]
        sTarget.textLabel?.text = "가림막"
        sTarget.detailTextLabel?.text = sItem["sunscreen"]
        sManageNm.textLabel?.text = "공기주입"
        sManageNm.detailTextLabel?.text = sItem["airPump"]
    }
